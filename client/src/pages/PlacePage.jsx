...
export default function PlacePage() {
    ...
    useEffect(() => {
        ...
        axios.get('/place/' + id).then(({ data: { data: { place } } }) => {
            setPlace(place)
        })
    ...
    if (!place) return (
        <div className='mt-8 font-4xl'>No places</div>
    )
    ...
    return (
        <div className='mt-8 bg-gray-100 -mx-8 px-8 px-8 pt-8'>
            <h1 className='text-3xl'>{place.title}</h1>
            <a target='_blank' href={'https://maps.google.com/?g=' + place.address} className='flex gp-1 my-3 block font-semibold underline'>
                ...
                <div className='grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden '>
                    ...
                    <div className='grid '>
                        ...
                        <div className='overflow-hidden'>
                            {place.photos?.[2] && (
                                <img onClick={() => setShowAllPhotos(true)} className='cursor-pointer aspect-square object-cover relative top-2' src={'http://localhost:3000/uploads/' + place.photos[2]} />
                            )}
                        </div>
                    </div>
                </div>
